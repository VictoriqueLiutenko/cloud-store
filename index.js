...
$('.js-showMore').click(function (event) {
  ...
  var controlUp = $(this).parent().find('.js-up');
  controlUp.css('padding-left', '0px').css('margin-right', '130px');

  var productsWrapper = $('.js-productsWrapper');
  var products = productsWrapper.find('.js-productWide');
...
function initializeSliders($input, $slider) {
  $slider.ionRangeSlider({
    ...
    onChange: function onChange(data) {
      var multiplier = $slider.data('multiplier') || 1;
...
$('.formComparison-controlsSlider').each(function () {
  var $slider = $(this);
  var $input = $slider.parent().find('.formComparison-controlsInput');
  initializeSliders($input, $slider);
});

$('.js-checkboxIcon').click(function () {
  var checkbox = $(this).parent().find('.js-invisibleCheckbox');
  checkbox.prop('checked', !checkbox.is(':checked'));

  return false;
});

},{"ion-rangeslider":15,"jquery":16}],3:[function(require,module,exports){
'use strict';
...
$('.js-radioHint').click(function () {
  var radiobutton = $(this).parent().find('.js-invisibleRadioButton');
  ...
  if ($(this).closest('.js-formInputWithHint').length > 0) {
    var radiobuttonWithHint = $(this).parent().find('.js-invisibleRadioButton');
    var hint = $(this).parent().parent().find('.js-formInputHint');
    hint.slideDown();
  }
  return false;
});
...
},{"ion-rangeslider":15,"jquery":16,"remodal":17,"slick-carousel":18,"slick-lightbox":19}],5:[function(require,module,exports){
'use strict';

var $ = require('jquery');

$(document).ready(function () {
  var descriptions = $('.js-product-description');

  descriptions.each(function () {
    var moreDescription = $(this).parent().find('.js-moreDescription');
    var realHeight = this.scrollHeight;

    if (realHeight > $(this).height()) {
      var blur = $(this).parent().find('.js-product-descriptionBlur');
...
$('.js-moreDescription').click(function () {
  ...
  var description = $(this).parent().find('.js-product-description');
  description.css({
    'overflow': 'visible',
    'max-height': 'none'
  });
...
$(document).ready(function () {
  var descriptions = $('.js-productWide-description');
  ...
  descriptions.each(function () {
    ...
    if (realHeight > $(this).height()) {
      var blur = $(this).parent().find('.js-productWide-descriptionBlur');
...
$('.js-moreDescription').click(function () {
  ...
  var description = $(this).parent().find('.js-productWide-description');
  description.css({
    'overflow': 'visible',
    'max-height': 'none'
  });
...
$(document).ready(function () {
  var slider = $('.promoBannerCarousel');
  slider.slick({
    autoplay: true,
    slidesToShow: 1,
    slidesToScroll: 1,
    ...
    cssEase: 'ease-out',
    easing: '_default',
    prevArrow: '<span class="promoBannerCarousel-arrow promoBannerCarousel-prevArrow"></span>',
    nextArrow: '<span class="promoBannerCarousel-arrow promoBannerCarousel-nextArrow"></span>',
...
var products = $('.js-recommendedToTry-products > div');
var informationBlock = $('.js-recommendedToTry-informationBlock');
var arrow = $('.js-recommendedToTry-informationBlockArrow');
var arrowLeft = Math.round(products.first().width() / 4);

var productsWrapperWidth = products.parent().width();
var allProductsWidth = products.length * products.first().width();
var distanceBetweenProducts = Math.floor((productsWrapperWidth - allProductsWidth) / (products.length - 1));

var previousIndex = null;
products.each(function (index, element) {
  $(this).click(function () {
    products.css('opacity', '0.5');
    var current = informationBlock[index];
    ...
    if ($(current).css('display') === 'none') {
      ...
      var currentArrowLeftPosition = arrowLeft + (distanceBetweenProducts + $(this).width() - arrow.width()) * index;
      arrow.animate({
...
$('.js-toggleRulles').click(function () {
  ...
  var rules = $('.js-registrationRules');
...
$(document).ready(function () {
  var sliderSingle = $('.screenshotCarousel-sliderSingle');
  var sliderNav = $('.screenshotCarousel-sliderNav');
  ...
  sliderNav.on('init', function (event, slick) {
    ...
    prevArrow: '<span class="screenshotCarousel-navArrow screenshotCarousel-navPrevArrow"></span>',
    nextArrow: '<span class="screenshotCarousel-navArrow screenshotCarousel-navNextArrow"></span>'
  });

  sliderSingle.on('afterChange', function (event, slick, currentSlide) {
    sliderNav.slick('slickGoTo', currentSlide);
    var currentNavSlide = sliderNav.find('.slick-slide[data-slick-index="' + currentSlide + '"]');
...
var imageInitialTopCoordinates = void 0;
$(document).ready(function () {
  var sidebarImage = $('.js-sidebarImage');
...
$(document).scroll(function () {
  var purchaseBlock = $('.js-purchaseBlock');

  if (purchaseBlock.length > 0) {
    var purchaseBlockTopCoordinates = purchaseBlock.offset().top;
    var purchaseBlockHeight = purchaseBlock.height();

    var image = $('.js-sidebarImage');
    var imageTopCoordinates = image.offset().top;
...
var hintLink = $('.js-sidebarHintLink');
...
var configureButton = $('.js-configureButton');

configureButton.each(function () {
  $(this).click(function () {
    var parent = $(this).closest('.js-subscriptionDetails');
    var blockToShow = $(parent).find('.js-onConfigureButtonClickShow');
...
var commentSubmit = $('.js-subscriptionConfigurations-commentSubmit');

commentSubmit.click(function () {
  var commentInput = $(this).parent().find('.js-subscriptionConfigurations-comment');
  var parent = $(this).closest('.js-subscriptionDetails');
  var commentLine = $(parent).find('.js-subscriptionDetails-comment');
...
$('.js-tariffOption').change(function () {
  ...
  var featureClass = selectedOption.data('target');
...
$('.js-togglableDescription-toggle').click(function () {
  var hiddenContent = $(this).parent().find('.js-togglableDescription-hide');
